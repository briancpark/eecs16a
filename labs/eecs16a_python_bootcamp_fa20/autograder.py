...
def test_q1(q1):
    A = np.array(
        [
            [0.447005, 0.21022493, 0.93728845, 0.83303825, 0.08056971],
...
def test_q4(q4):
    ...
    assert np.array_equal(q4(A, B), Output), (
        "Question 4 Failed!\nInput:\nA: %r\nB: %r\nCorrect Answer:\n%r\nYour Answer:\n%r"
        % (A, B, Output, q4(A, B))
    )
...
def test_q6(q6):
    ...
    assert np.array_equal(q6(v, N), Output), (
        "Question 6 Failed!\nInput:\nv: %r\nN: %r\nCorrect Answer:\n%r\nYour Answer:\n%r"
        % (v, N, Output, q6(v, N))
    )
...
def test_q7(q7):
    assert np.array_equal(q7(np.eye(400), 137), np.eye(263)), (
        "Question 7 Failed!\nInput:\nI(400)\nN: 137\nCorrect Answer:\n%r\nYour Answer:\n%r"
        % (np.eye(263), q7(np.eye(400), 137))
    )
...
def test_q9(q9):
    ...
    Output = np.array([[1, 2, 3], [4, 5, 6], [0, 0, 0]]), np.array(
        [[1, 1, 0], [1, 1, 0], [1, 1, 0]]
    )
    assert np.array_equal(q9(A, B), Output), (
        "Question 9 Failed!\nInput:\nA: %r\nB: %r\nCorrect Answer:\n%r\nYour Answer:\n%r"
        % (A, B, Output, q9(A, B))
    )
...
def test_q10(q10):
    ...
    assert np.array_equal(q10(A, B, p), Output), (
        "Question 10 Failed!\nInput:\nA: %r\nB: %r\np: 2\nCorrect Answer:\n%r\nYour Answer:\n%r"
        % (A, B, Output, q10(A, B, p))
    )
